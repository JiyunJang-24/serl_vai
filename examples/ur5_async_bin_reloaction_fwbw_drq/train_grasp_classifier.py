...
def main(_):
    ...
    train_reward_classifier(env.wrist_observation_space, env.action_space)
    env.close()
...
def train_reward_classifier(observation_space, action_space):
    ...
    pos_buffer = populate_data_store_ur5(pos_buffer, FLAGS.positive_demo_paths[0], image_keys)
    ...
    # import pdb; pdb.set_trace()
    neg_buffer = populate_data_store_ur5(neg_buffer, FLAGS.negative_demo_paths[0], image_keys)
