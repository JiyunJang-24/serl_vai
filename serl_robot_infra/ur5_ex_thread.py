...
async def control_robot(frequency=1):
    ...
    while True:
        ...
        # now
        rtde_c.moveL([-0.03154429634040348, 0.45562098158079695, 0.42794852953449236, 3.0525346308566377, 0.03185739903924983, 0.056595364278061805], 0.1, 0.1)
        await asyncio.sleep(dt)
        # right
        rtde_c.moveL([-0.013890877171975489, 0.4544898081640227, 0.4283669239116298, 3.073285442468474, 0.030361074239637114, 0.06421661706455328], 0.1, 0.1)    
        await asyncio.sleep(dt)
        # now
        rtde_c.moveL([-0.03154429634040348, 0.45562098158079695, 0.42794852953449236, 3.0525346308566377, 0.03185739903924983, 0.056595364278061805], 0.1, 0.1)
        await asyncio.sleep(dt)
        # left 
        rtde_c.moveL([-0.05154429634040348, 0.45562098158079695, 0.42794852953449236, 3.0525346308566377, 0.03185739903924983, 0.056595364278061805], 0.1, 0.1)
        await asyncio.sleep(dt)
        # rtde_c.moveL(
        #     [0.17919724976642143, -0.5828446000209568, 0.2940166234704726, -3.128745750991788, 0.24643694191444748, -0.059692257337022527], 
        #     0.1, 0.1
