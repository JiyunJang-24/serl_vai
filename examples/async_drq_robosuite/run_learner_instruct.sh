...
python async_drq_randomized_sparse_reward_instruction_grasp_critic.py "$@" \
    ...
    --exp_name=serl_dev_drq_rlpd20demos_dense_grasp_divide_instruct_learner_no_HumanInter_bs_64 \
    --seed 0 \
    --random_steps 200 \
    --training_starts 200 \
    ...
    --checkpoint_path /data1/JY/serl/robosuite/checkpoint/combined_dense_grasp_divide \
