...
flags.DEFINE_integer("max_traj_length", 500, "Maximum length of trajectory.")
...
def main(_):
    ...
    input_keys = [key for key in env.observation_space.keys()]
    front_image_keys = [
    ...
    if not FLAGS.eval_checkpoint_step:
        ...
        import os
        # replay_buffer = populate_data_store_ur5(replay_buffer, FLAGS.demo_paths[0], key_list=input_keys)
        demo_path = FLAGS.demo_paths[0]  # 폴더 경로
        ...
        for demo_file in demo_files:
            ...
            print(f"Loaded {demo_file}, buffer size: {len(replay_buffer)}")
