...
python async_drq_randomized_grasp_reward_sub_instruction.py "$@" \
    --actor \
    --render \
    --env FrankaBinRelocation-Vision-v0 \
    --exp_name=serl_dev_drq_rlpd20demos_robosuite_grasp_sub_instruct_actor_no_HumanInter \
    --seed 0 \
    --random_steps 200 \
    ...
    --grasp_reward_classifier_ckpt_path "/home/fick17/Desktop/JY/SERL/serl/examples/async_drq_robosuite/classifier_ckpt/grasp_checkpoint_1000" \
    # --fw_ckpt_path /home/fick17/Desktop/JY/SERL/serl/examples/async_drq_robosuite/ckpt/fw/fw_checkpoint_5000 \
    # --bw_ckpt_path /home/fick17/Desktop/JY/SERL/serl/examples/async_drq_robosuite/ckpt/bw/bw_checkpoint_3000 
